...
<body id="top">
            ...
            <header id="header" class="hoc clear">
                ...
                <nav id="mainav" class="fl_right">
                    <ul class="clear">
                        ...
                        <li id="login-form"><button id="OpenDialog" style=" background:rgba(0,0,0,0);border:none; font-size:15px; cursor:pointer">LOGIN</button></li>
            ...
            <div id="modal">
                <div id="modal-bg">
                    ...
                    <div class="form">
                        ...
                        <div class="form-1">
                            <div class="form-2">
                                <button id="close" style="height:40px;width:40px;border-radius:40px; font-size: 15px; text-align:center; background: rgba(50,150,50,.90); margin-left:620px; margin-top:0; color: white; text-align:center">x</button>
                                <fieldset>
            ...
            <ul class="nospace group">
                <li class="one_quarter first">
                    <article><a class="btn" href="#"><i class="tr tr-airplane37"></i></a>
                        <h4 class="heading underline center"><a href="#">International</a></h4>
                    </article>
                </li>
                <li class="one_quarter">
                    <article><a class="btn" href="#"><i class="tr tr-transport68"></i></a>
                        <h4 class="heading underline center"><a href="#">Cruise</a></h4>
                    </article>
                </li>
                <li class="one_quarter">
                    <article><a class="btn" href="#"><i class="tr tr-car167"></i></a>
                        <h4 class="heading underline center"><a href="#">Domestic</a></h4>
                    </article>
                </li>
                <li class="one_quarter">
                    <article><a class="btn" href="#"><i class="tr tr-building90"></i></a>
                        <h4 class="heading underline center"><a href="#">Book a Vacation</a></h4>
                    </article>
                </li>
            </ul>
            <!-- ################################################################################################ -->
            ...
            <ul id="home" class="nospace group elements">
                <li class="one_third first">
                    <figure class="elementwrapper">
                        <a class="imgoverlay" href="#"><img src="images/demo/480x285.png" alt=""></a>
                        <figcaption>Kashmir</figcaption>
                    </figure>
                </li>
                <li class="one_third">
                    <figure class="elementwrapper">
                        <a class="imgoverlay" href="#"><img src="images/demo/480x285-1.png" alt=""></a>
                        <figcaption>Sikkim</figcaption>
                    </figure>
                </li>
                <li class="one_third">
                    <figure class="elementwrapper">
                        <a class="imgoverlay" href="#"><img src="images/demo/480x285-2.png" alt=""></a>
    ...
    <div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/02.png');">
        <div class="hoc container clear">
            <!-- ################################################################################################ -->
            <h2 class="heading">Most popular International Destinations</h2>
            <p class="btmspace-50">Travel Far enough. You meet yourself. <span style="font-size:10px">- Cloud Atlas</span><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;View All Destinations &raquo;</a></p>
            <ul class="nospace group elements">
                <li class="one_quarter first">
                    <figure class="elementwrapper">
                        <a class="imgoverlay" href="#"><img src="images/demo/320x220.png" alt=""></a>
    ...
    <div class="wrapper row3">
        <div class="hoc container clear">
            ...
            <p class="btmspace-50">Get the best out of us. <a href="#">View All Deals &raquo;</a></p>
        ...
        <div id="newsletter" class="hoc clear">
            ...
            <form class="three_quarter" action="try.php" method="POST">
                <div class="clear">
                    ...
                    <input class="one_third first" type="text" name="user" placeholder="Username" required />

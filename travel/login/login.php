		...
		<div class = "form">
			<div class="form-1">
				...
				<div class = "form-2">
					...
					<p style = "font-family:sans-serif; color:rgb(0,150,0);font-size:12px; margin-left: 50px; margin-top: 0">Already have an account?<button id ="sign-up"><a href ="../index.php" style= "text-align:right">Home</a></button></p>
